...
class BlogPostItem extends StatelessWidget {
        ...
        child: Row(
          children: [
            if (orientation == Orientation.landscape) ...[
              _Image(imagePath: blogPost.image, width: MediaQuery.sizeOf(context).width * 0.12),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: List.generate(
                      ...
                      (index) => SkillElement(skillName: blogPost.tags[index]),
                    ),
                  ),
  ...
  void onTap() {
    FirebaseAnalyticsWeb().logEvent(name: 'open_blog_post', parameters: {
      ...
      'blog_post_link': blogPost.link,
    });
    launchUrlString(blogPost.link);
  }
}
